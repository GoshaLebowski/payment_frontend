					...
					<table className={`w-full`}>
						...
						<tbody>
							{payments?.map((payment, index) => (
								...
								>
									<td
										className={`px-2 py-4 font-mono text-xs text-gray-500`}
									>
										{payment.id}
									</td>
									<td
									...
									<td
										className={`px-2 py-4 text-sm font-semibold text-gray-900`}
									>
										{payment.amount}
										{payment.provider ===
										PaymentHistoryResponseProvider.STARS
											? ` ⭐`
											: `₽`}
									</td>
									<td
										className={`px-2 py-4 text-sm text-gray-600`}
									>
